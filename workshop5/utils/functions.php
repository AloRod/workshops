...
function saveUser($user) {
  ...
  $stmt = $conn->prepare("INSERT INTO users (firstName, lastName, email, province_id, password) VALUES (?, ?, ?, ?, ?)");

  // Vinculamos los parámetros
  $stmt->bind_param("sssiss", $user['firstName'], $user['lastName'], $user['email'], $user['province_id'], $hashedPassword);
